...
export default function Paywall2({ navigation }) {
  ...
  async function handleMonthlyPurchase() {
    ...
    const purchaserInfo = await Purchases.purchasePackage(currentOffering.monthly).catch(
      (error) => {
        setSpinner(false);
      },
    );
  ...
  return (
    <ScrollView
      ...
      style={[
        ...
        tw`bg-slate-900 ${Platform.OS == 'android' && `mt-10`}`,
      ]}
    >
      <SafeAreaView style={[tw`flex-1 bg-slate-900`, { width: width, height: height }]}>
        ...
        <View
          style={[
            tw`flex-1 justify-start mt-12`,
            { height: height, width: width, opacity: 1, position: 'absolute' },
          ]}
        >
          <View style={tw`mb-5 `}>
            <Text style={tw`text-white text-2xl text-center font-bold`}>
              Welcome to ScriptureChat
            </Text>
            <Text style={tw`text-slate-200 text-center font-light`}>
              Pick a plan to get unlimited access to all features
            </Text>
          ...
          <View style={tw` px-5`}>
            <View style={tw`flex-row items-center`}>
              ...
              <View style={tw`flex-1`}>
                ...
                <Text style={tw`text-slate-300 font-light`}>
                  This includes unlimited conversations and the latest updates to our AI Chat
                  feature
                </Text>
              </View>
            </View>
            ...
            <View style={tw`flex-row items-center pt-5`}>
              ...
              <View style={tw`flex-1 `}>
                <Text style={tw`text-white font-bold`}>
                  Customize The Chat Experience To Your Faith Journey
                </Text>
                <Text style={tw`text-slate-300 font-light`}>
                  Set your denomination, geographics, knowledge level and more to tune the chat to
                  where you are.{' '}
                </Text>
              </View>
            </View>
            ...
            <View style={tw`flex-row items-center pt-5`}>
              ...
              <View style={tw`flex-1`}>
                <Text style={tw`text-white font-bold`}>
                  Early access to new tools, content and exercises
                </Text>
                <Text style={tw`text-slate-300 font-light`}>
                  We are always testing and rolling out new features. Be the first to get our newest
                  features to see how AI can help deepen your knowledge and understanding of
                  scripture
                </Text>
              </View>
            </View>
          ...
          {currentOffering ? (
            <View style={tw` items-center`}>
              <View style={tw`items-center flex-row mt-5`}>
                {currentOffering && currentOffering.monthly && (
                  <View style={tw`flex-col`}>
                    <TouchableOpacity
                      onPress={() => handleMonthlyPurchase()}
                      style={[
                        tw`flex-col px-5 py-3 mb-2 border-2 border-black bg-blue-900  rounded-3xl justify-center `,
              ...
              <View style={tw`flex-col`}>
                <TouchableOpacity
                  ...
                  style={tw`flex-col mb-5 mt-3  rounded-2xl  `}
                >
                ...
                <TouchableOpacity
                  ...
                  style={[tw`flex-col mb-5  rounded-2xl  `]}
                >
                  <Text style={tw`ml-2 text-white font-bold text-lg text-center`}>
                ...
                {Platform.OS == 'android' && (
                  <View>
                    <TouchableOpacity
                      ...
                      style={[tw`flex-col mb-5  rounded-2xl  `]}
                    >
                      <Text style={tw`ml-2 text-white font-light text-center`}>
