  ...
  const items = [
    {
      ...
      descriptionLong:
        'In this module, you’ll learn about the window of tolerance. The window of tolerance is the zone of arousal we ideally want to be in, in which an individual has the most effective functioning. Complete this module to find out if and how often you go out of your window of tolerance and how this may be impacting your day-to-day.',
    ...
    },
    {
      ...
      descriptionLong:
        'Lack of sleep impacts your ability to function effectively and engage with the world around you. In this module, you will learn sleep hygiene strategies to improve the quality of your sleep. From building a better bedtime routine to what to do if you’re tossing and turning, this module covers it all. ',
        ...
        <ScrollView>
          <View style={tw`flex-1 justify-start  mt-20 pb-30`}>
            ...
            <TouchableOpacity
              ...
              style={[tw`ml-10 rounded-xl mb-3`, { aspectRatio: 8 / 3, width: '80%' }]}
            >
              <View
                style={tw`flex flex-row items-center p-3 bg-slate-800 bg-opacity-40  rounded-2xl`}
              >
                ...
                <View id="innerCard" style={tw`flex flex-col pl-2 mr-2 pb-4 pt-2 items-start`}>
                  ...
                  <View>
                    <Text style={tw`pr-10 items-start text-violet-200 mr-8`}>
                      Keep a log of how you're feeling day-to-day.
                    </Text>
                  </View>
                </View>
              </View>
            ...
            <TouchableOpacity
              id="card"
              onPress={() => navigation.navigate('FreeWriting')}
              style={[
                tw`ml-10 rounded-xl mb-3  bg-slate-800 bg-opacity-40`,
                { aspectRatio: 8 / 3, width: '80%' },
              ]}
            >
              <View style={tw`flex flex-row items-center p-3  rounded-2xl`}>
                ...
                <View id="innerCard" style={tw`flex flex-col pl-2 mr-2 pb-4 pt-2 items-start`}>
                  ...
                  <View>
                    <Text style={tw`pr-10 items-start text-violet-200 mr-8`}>
                      Write anything that comes to mind in this unstructured writing exercise. This
                      can be completed any time of day.
                    </Text>
                  </View>
                </View>
              </View>
